...
const UserAccountSettings = () => {
    ...
    const [noTeamNameAvailable, setNoTeamNameAvailable] = useState<
        string | null
    >(null);
    ...
    useEffect(() => {
        const fetchUserInfo = async () => {
            try {
                ...
                setNoTeamNameAvailable(
                    await userService.getNoTeamNameAvailable()
                );
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (userStudentNumber)
                Object.assign(dataToSend, { userStudentNumber });
