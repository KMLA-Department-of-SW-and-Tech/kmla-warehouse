...
const UserAccountSettings = () => {
  ...
  const [userStudentNumber, setUserStudentNumber] = useState<number | null>(
    null
  );
  const [teamNames, setTeamNames] = useState<string[]>([]);
  const [noTeamNameAvailable, setNoTeamNameAvailable] = useState<string | null>(
    null
  );
  ...
  useEffect(() => {
    const fetchUserInfo = async () => {
      try {
        ...
        setUserClassNumber(
          userInfo.userClassNumber ? Number(userInfo.userClassNumber) : null
        );
        setUserStudentNumber(
          userInfo.userStudentNumber ? Number(userInfo.userStudentNumber) : null
        );
        setTeamNames(teams);
              ...
              <Form.Item label="반">
                {loadingInfo ? (
                  ...
                  <Input
                    ...
                    onChange={(e) => setUserClassNumber(Number(e.target.value))}
                  />
                )}
              </Form.Item>
              <Form.Item label="학번">
                {loadingInfo ? (
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setUserStudentNumber(Number(e.target.value))
                    }
                  />
                )}
              </Form.Item>
