...
=======
  ...
  SaveOutlined,
  UploadOutlined,
>>>>>>> 699ff1d2e044a457532bd27205eb37181b268323
...
const AdminItem: React.FC = () => {
  ...
  const handleUpdateItem = async (id: string, updatedItem: PatchItem) => {
    ...
    if (updatedItem.totalQuantity)
      formData.append("totalQuantity", updatedItem.totalQuantity.toString());
                ...
                <EditableProTable<GetItem>
                  ...
                  editable={{
                    ...
                    onSave: async (rowKey, data) => {
                      await handleUpdateItem(data._id, data as PatchItem); // refresh
